...
import com.mb.android.utils.common.OpenUDID_manager;
...
//	}
    ...
    public static String getCurrentPid() {
        if (Helper.isNull(sPid)) {
        	...
        	Object pidObj = getMetaData(MBApplication.getInstance(),tandyPid);
    ...
    public static String getCurrentChannel() {
        if (Helper.isNull(sChannel)) {
        	...
        	Object channelObj = getMetaData(MBApplication.getInstance(),tandyCh);
    ...
    public static String getSID() {
        try {
            TelephonyManager tm = (TelephonyManager) MBApplication.getInstance()
    ...
    public static String getMacAddress() {
        try {
            WifiManager wifi = (WifiManager) MBApplication.getInstance().getSystemService(Context.WIFI_SERVICE);
