...
import com.weima.aishangyi.jiaoshi.adapter.DistanceAdapter;

/**
 * Created by cgy
 */
public class DistancePop extends PopupWindow implements View.OnClickListener {
    ...
    public DistancePop(Context context, SelectListener listener) {
        super(context);
    ...
    private void initComponent() {
        ...
        adapter = new DistanceAdapter(mContext, null);
