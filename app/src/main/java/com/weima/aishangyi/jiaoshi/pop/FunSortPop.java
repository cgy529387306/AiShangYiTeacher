...
import com.weima.aishangyi.jiaoshi.adapter.FunSortAdapter;

/**
 * Created by cgy
 */
public class FunSortPop extends PopupWindow implements View.OnClickListener {
    private View rootView;
    private ListView listView;
    private Context mContext;
    private FunSortAdapter adapter;
    ...
    public FunSortPop(Context context, SelectListener listener) {
        super(context);
    ...
    private void initComponent() {
        ...
        adapter = new FunSortAdapter(mContext, null);
