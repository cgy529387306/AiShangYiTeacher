...
import com.weima.aishangyi.jiaoshi.fragment.PaymentDetailFragment;
...
public class UserPaymentDetailActivity extends BaseActivity {
    ...
    public class MyAdapter extends FragmentStatePagerAdapter {
        private final String[] titles = {"收入明细", "充值提现"};
        ...
        public Fragment getItem(int position) {
            if (position == 0){
                return PaymentDetailFragment.newInstance(1);
            }else{
                return PaymentDetailFragment.newInstance(3);
            }
        }
