 ...
 * @author cgy
 */
public class TeacherGuideActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setCustomTitle("老师指南");
        setContentView(R.layout.activity_teacherguide);
        initUI();
        requestData();
    }
    ...
    private void initUI() {
        ...
        adapter = new GuideAdapter(TeacherGuideActivity.this,list);
