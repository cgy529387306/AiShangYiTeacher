package com.weima.aishangyi.jiaoshi.chat.db;
...
import com.weima.aishangyi.jiaoshi.chat.domain.InviteMessage;
...
public class DemoDBManager {
    ...
    private DemoDBManager(){
        dbHelper = DbOpenHelper.getInstance(WMApplication.getInstance().getApplicationContext());
    }
