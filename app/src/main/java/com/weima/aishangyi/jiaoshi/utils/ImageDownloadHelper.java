...
import com.mb.android.utils.BitmapUtil;
...
public class ImageDownloadHelper {
	 ...
	 */
	public static void startDownLoadImg(String url, DownLoadCallBack callBack, Object... extras) {
	...
	public static String getImageCachePath(String url) {
		return Environment.getExternalStorageDirectory()+"/com.weima.aishangyi/download/" + getCacheKey(url);
	}
