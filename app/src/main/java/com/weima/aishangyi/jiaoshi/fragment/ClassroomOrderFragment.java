...
import com.weima.aishangyi.jiaoshi.adapter.ClassroomOrderAdapter;
import com.weima.aishangyi.jiaoshi.constants.ProjectConstants;
import com.weima.aishangyi.jiaoshi.entity.ClassOrderResp;
 ...
 * 课程订单
 */
public class ClassroomOrderFragment extends Fragment implements XListView.IXListViewListener , ResponseListener {
    private ClassroomOrderAdapter mAdapter;
    ...
    public static ClassroomOrderFragment newInstance(int type) {
        //对外提供创建实例的方法，你给我需要显示的内容，我给你Fragment实例
        ClassroomOrderFragment fragment = new ClassroomOrderFragment();
        Bundle b = new Bundle();
        b.putInt(TYPE, type);
    ...
    private void initUI(View view) {
        mAdapter = new ClassroomOrderAdapter(getActivity());
    ...
    public boolean onResponseSuccess(int gact, String response,
        ...
        try {
            ClassOrderResp entity = JsonHelper.fromJson(response, ClassOrderResp.class);
    ...
    private void requestData(){
        ...
        post(ProjectConstants.Url.ORDER_LESSON, requestMap);
    }
