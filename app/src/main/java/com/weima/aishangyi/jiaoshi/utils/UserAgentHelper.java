...
public class UserAgentHelper {
	...
	protected static String getDeviceInfo() {
		...
		StringBuilder deviceInfo = new StringBuilder()
				...
				.append("&openid=")
				.append(AppHelper.getDeviceUniqueString(MBApplication
						.getInstance()));
	...
	protected static String getProjectInfo() {
		...
		StringBuilder projectInfo = new StringBuilder()
				...
				// 浏览器标识
				.append("&ua=")
				.append(new WebView(MBApplication.getInstance()).getSettings()
						.getUserAgentString());
	...
	public static int getNetWorkType() {
		ConnectivityManager connectionManager = (ConnectivityManager) MBApplication
	...
	public static String getBssid() {
		WifiManager wm = (WifiManager) MBApplication.getInstance()
