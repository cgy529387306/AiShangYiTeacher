package com.weima.aishangyi.jiaoshi.chat.fragment;
...
import com.weima.aishangyi.jiaoshi.chat.db.UserDao;
import com.weima.aishangyi.jiaoshi.chat.domain.RobotUser;
...
public class MyChatFragment extends EaseChatFragment implements EaseChatFragmentHelper {
    ...
    public void onSetMessageAttributes(EMMessage message) {
        ...
        message.setAttribute(Constant.USER_ID, CurrentUser.getInstance().getId());
        message.setAttribute(Constant.USER_NAME, ProjectHelper.getCommonText(CurrentUser.getInstance().getNickname()));
        message.setAttribute(Constant.HEAD_IMAGE_URL, ProjectHelper.getCommonText(CurrentUser.getInstance().getIcon()));
    ...
    public void onAvatarClick(String username) {
        Intent intent = new Intent(getActivity(), ConcernInfoActivity.class);
...
//            //存入内存
//            UserDao dao = new UserDao(WMApplication.getInstance());
