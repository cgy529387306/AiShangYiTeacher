...
import com.weima.aishangyi.jiaoshi.adapter.MyTeacherAdapter;
import com.weima.aishangyi.jiaoshi.constants.ProjectConstants;
import com.weima.aishangyi.jiaoshi.entity.MyTeacherResp;
 ...
 * 联系人
 */
public class MyStudentFrament extends Fragment implements XListView.IXListViewListener,ResponseListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mLocalBroadcastManager.registerReceiver(mUpdateUserInfoReceiver, new IntentFilter(ProjectConstants.BroadCastAction.UPDATE_FANS_LIST));
    }
    ...
    private void initUI(View view) {
        ...
        mAdapter = new MyTeacherAdapter(getActivity());
    ...
    public boolean onResponseSuccess(int gact, String response,
        ...
        MyTeacherResp entity = JsonHelper.fromJson(response,MyTeacherResp.class);
    ...
    private void requestData(){
        ...
        post(ProjectConstants.Url.MY_STUDENT_LIST, requestMap);
    }
    ...
    private void requestFollow(){
        ...
        post(ProjectConstants.Url.FOLLOW, requestMap);
    }
