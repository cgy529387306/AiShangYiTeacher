...
import com.weima.aishangyi.jiaoshi.adapter.FilterSortAdapter;

/**
 * Created by cgy
 */
public class SelectFilterSortPop extends PopupWindow implements View.OnClickListener {
    ...
    public SelectFilterSortPop(Context context, SelectListener listener) {
        super(context);
    ...
    private void initComponent() {
        ...
        adapter = new FilterSortAdapter(mContext, null);
