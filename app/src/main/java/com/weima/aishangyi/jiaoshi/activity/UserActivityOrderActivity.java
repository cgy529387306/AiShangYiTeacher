...
import com.weima.aishangyi.jiaoshi.fragment.ActivityOrderFragment;
 ...
 * 活动订单
 */
public class UserActivityOrderActivity extends BaseActivity {
    ...
    public class MyAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            if (position == 0) {
                return ActivityOrderFragment.newInstance(1);
            }else{
                return ActivityOrderFragment.newInstance(3);
            }
        }
