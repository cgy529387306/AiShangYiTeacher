 ...
 * 系统消息
 */
public class MsgSystemFragment extends Fragment implements XListView.IXListViewListener,ResponseListener {
    ...
    private void requestData(){
        ...
        post(ProjectConstants.Url.MSG_SYSTEM, requestMap);
    }
