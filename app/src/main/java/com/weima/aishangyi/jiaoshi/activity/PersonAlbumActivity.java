...
public class PersonAlbumActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_person_ablum);
        initUI();
        initData();
    }
    ...
    private void initUI() {
        ...
        mAdaptar = new PicAdapter(PersonAlbumActivity.this, pathList, imgDel);
    ...
    public boolean onResponseSuccess(int gact, String response,
        ...
        if ("200".equals(entity.getCode())){
            LocalBroadcastManager.getInstance(PersonAlbumActivity.this).sendBroadcast(new Intent(ProjectConstants.BroadCastAction.UPDATE_USER_INFO));
    ...
    private void selectImage() {
        try {
            Intent intent = new Intent(PersonAlbumActivity.this, MultiImageSelectorActivity.class);
            // 是否显示拍摄图片
    ...
    private void uploadPhoto(final String path){
        ProgressDialogHelper.showProgressDialog(PersonAlbumActivity.this,"上传中...");
    ...
    private class ImgDel implements PicAdapter.DelImg {
        ...
        public void addImg() {
            if (pathList.size() < 10) {
                bottomMenuDialog = new BottomMenuDialog.Builder(PersonAlbumActivity.this)
