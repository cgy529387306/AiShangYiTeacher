 ...
 * Created by cgy
 */
public class AnswerHelpPop extends PopupWindow implements View.OnClickListener {
    ...
    public AnswerHelpPop(Context context, SelectListener listener) {
        super(context);
        this.mContext = context;
        this.selectListener = listener;
        rootView = View.inflate(mContext, R.layout.pop_answer_help, null);
        setFocusable(true);
